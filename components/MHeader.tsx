...
export default function MHeader() {
  ...
  <svg className="rocketManSVG" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 600">
    ...
    <g className="speedLines" stroke="#3e3e3e" strokeWidth={2} strokeLinejoin="round">
      <line id="speedLine0" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine1" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine2" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine3" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine4" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine5" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine6" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine3" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine4" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine5" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
      <line id="speedLine6" fill="none" strokeMiterlimit={10} x1={0} y1={0} x2={0} y2={0} />
